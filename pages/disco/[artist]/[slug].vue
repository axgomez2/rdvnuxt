        ...
        <div class="lg:col-span-8 space-y-6">
          ...
          <div class="bg-stone-50 border border-stone-200 rounded-xl p-6 space-y-4">
            ...
            <div class="flex items-center justify-center gap-3 pt-2">
              ...
              <button @click="shareOnInstagram" class="p-2.5 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white rounded-full hover:opacity-90 transition-opacity" title="Instagram">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
const WHATSAPP_NUMBER = '5511947159293'
...
// Compartilhar no Instagram (copia o texto para o usuário colar)
const shareOnInstagram = () => {
  if (!vinyl.value) return
  const text = `🎵 ${vinyl.value.artist} - ${vinyl.value.title}\n💰 ${formattedPrice.value}\n\n🔗 ${window.location.href}\n\n#vinil #vinyl #disco #rdvdiscos`
