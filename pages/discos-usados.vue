<template>
  <div class="bg-white min-h-screen">
    <div class="container mx-auto px-4 py-8">
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-3xl md:text-4xl font-bold text-stone-900">Discos Usados</h1>
        <p class="text-stone-600 mt-2">Raridades e clássicos de segunda mão com qualidade garantida</p>
      </div>
...
// Scroll restoration
const SCROLL_KEY = 'discos-usados-scroll'
...
useHead({
  title: computed(() => {
    ...
    return cat ? `${cat.name} - Discos Usados - RDV Discos` : 'Discos Usados - RDV Discos'
  }),
  meta: [
    { name: 'description', content: 'Discos de vinil usados com qualidade garantida. Raridades e clássicos para colecionadores.' }
  ]
})
</script>
